    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tg_id', models.BigIntegerField(unique=True, verbose_name='tg_id')),
                ('tg_chat_id', models.BigIntegerField(verbose_name='tg_chat_id')),
                ('username', models.CharField(blank=True, default=None, max_length=256, null=True, verbose_name='tg_username')),

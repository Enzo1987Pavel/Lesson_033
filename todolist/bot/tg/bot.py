...
from bot.func import generator_code_verification
...
class TgBot:
    ...
    def check_user(self, user_ud: int, tg_chat_id: int) -> TgUser | bool:
        user_tg, created = TgUser.objects.get_or_create(user_ud=user_ud, tg_chat_id=tg_chat_id)
